...
df_train = pd.concat(
    ...
    df_train_num.drop(columns = ['userid','end','isstop','isr15','isbl','isgl','iszankoku','istensei','istenni','pc_or_k']), 
...
df_test = pd.concat(
    [
    df_test_num.drop(columns = ['userid','end','isstop','isr15','isbl','isgl','iszankoku','istensei','istenni','pc_or_k']), 
